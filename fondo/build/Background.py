...
ASSETS_PATH = OUTPUT_PATH / Path(r"/Users/jezzzcan/Desktop/TT2_Brainboard/Tkinter-Designer-master/fondo/build/assets/frame0")
...
canvas.create_image(60.0, 54.0, image=image_image_2)

canvas.create_text(
    46.0, 103.0,
    anchor="nw",
    text="Selecciona el tipo de fondo:",
    fill="#FFFFFF",
    font=("Inter Black", 40 * -1)
)

# Crear labels en lugar de botones
create_label(221.0, 353.0, "button_1.png", "button_1_hover.png", "button_1_pressed.png", lambda: print("button_1 clicked"))
create_label(184.0, 264.0, "button_2.png", "button_2_hover.png", "button_2_pressed.png", lambda: print("button_2 clicked"))
create_label(189.0, 180.0, "button_3.png", "button_3_hover.png", "button_3_pressed.png", lambda: print("button_3 clicked"))
